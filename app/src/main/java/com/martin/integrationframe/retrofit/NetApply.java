package com.martin.integrationframe.retrofit;
...
import com.martin.integrationframe.constant.API;
import com.martin.integrationframe.retrofit.cookie.CookieJarImpl;
import com.martin.integrationframe.retrofit.cookie.CustomCookieStore;
import com.martin.integrationframe.retrofit.util.NetworkUtils;
    ...
    private NetApply() {
       /* HttpLoggingInterceptor interceptor = new HttpLoggingInterceptor();
        ...
        OkHttpClient okHttpClient = new OkHttpClient.Builder()
                ...
                .cookieJar(new CookieJarImpl(new CustomCookieStore())) //长效Cookie
                .cache(cache)
                .build();
