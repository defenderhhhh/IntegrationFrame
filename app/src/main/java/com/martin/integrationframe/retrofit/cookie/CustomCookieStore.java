package com.martin.integrationframe.retrofit.cookie;
...
import com.martin.integrationframe.retrofit.cookie.store.CookieStore;
import com.martin.integrationframe.retrofit.cookie.store.SerializableHttpCookie;
...
public class CustomCookieStore implements CookieStore {
    ...
    private static final String TAG = CustomCookieStore.class.getSimpleName();

    private final HashMap<String, ConcurrentHashMap<String, Cookie>> cookies;
    private final SharedPreferences cookiePrefs;

    public CustomCookieStore() {
        cookiePrefs = MyApplication.getInstance().getSharedPreferences(COOKIE_PREFS, Context.MODE_PRIVATE);
        cookies = new HashMap<>();
